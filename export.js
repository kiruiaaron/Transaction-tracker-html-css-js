export default class BudgetTracker{
    ...
    <tr>
    <td>
        <input class="input input-description" type="text" placeholder="Add a Title (e.g. Salary, food,rent etc.)">
    </td>
    <td>
    ...
    updateSummary(){
        ...
        const totalFormater = new Intl.NumberFormat("en-US",{
            style: "currency",
            currency: "USD"
        }).format(total);

        this.root.querySelector('.total').textContent = totalFormater;
